          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 mt-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={type} onValueChange={(value: string) => setType(value as Sensor['type'])}>
              ...
              <div className="space-y-2">
                ...
                <Select value={visibility} onValueChange={(value: string) => setVisibility(value as Sensor['visibility'])}>
                  <SelectTrigger className="bg-input border-border">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="bg-popover border-border">
